...
func drawCircle(c fyne.Canvas, circle *canvas.Circle, pos fyne.Position, base *image.RGBA, clip image.Rectangle) {
...
func drawGradient(c fyne.Canvas, g gradient, pos fyne.Position, base *image.RGBA, clip image.Rectangle) {
	bounds := g.Size()
...
func drawImage(c fyne.Canvas, img *canvas.Image, pos fyne.Position, base *image.RGBA, clip image.Rectangle) {
	bounds := img.Size()
	if bounds.IsZero() {
		return
	}
...
func drawPixels(x, y, width, height int, mode canvas.ImageScale, base *image.RGBA, origImg image.Image, clip image.Rectangle) {
...
func drawLine(c fyne.Canvas, line *canvas.Line, pos fyne.Position, base *image.RGBA, clip image.Rectangle) {
...
func drawTex(x, y, width, height int, base *image.RGBA, tex image.Image, clip image.Rectangle) {
...
func drawText(c fyne.Canvas, text *canvas.Text, pos fyne.Position, base *image.RGBA, clip image.Rectangle) {
	bounds := text.MinSize()
	width := internal.ScaleInt(c, bounds.Width)
	height := internal.ScaleInt(c, bounds.Height)
...
func drawRaster(c fyne.Canvas, rast *canvas.Raster, pos fyne.Position, base *image.RGBA, clip image.Rectangle) {
	bounds := rast.Size()
	if bounds.IsZero() {
		return
	}
...
func drawRectangleStroke(c fyne.Canvas, rect *canvas.Rectangle, pos fyne.Position, base *image.RGBA, clip image.Rectangle) {
...
func drawRectangle(c fyne.Canvas, rect *canvas.Rectangle, pos fyne.Position, base *image.RGBA, clip image.Rectangle) {
